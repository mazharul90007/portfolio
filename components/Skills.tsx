    ...
    <section className="relative py-24 w-full overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="lg:col-span-3 relative group p-10 rounded-[3rem] border border-white/10 hover:border-indigo-500/40 transition-all duration-300 overflow-hidden bg-[#0a0a0a]/10 jellyfish-card">
          ...
          <div className="lg:col-span-2 relative group p-10 rounded-[3rem] border border-white/10 hover:border-indigo-500/40 transition-all duration-300 overflow-hidden bg-[#0a0a0a]/10 jellyfish-card">
        ...
        {/* Soft Skills Section */}
        <div className=" mt-6 group p-10 rounded-[3rem] border border-white/10 hover:border-indigo-500/40 transition-all duration-300 bg-white/2 overflow-hidden relative jellyfish-card">
