  ...
  return (
    <section className="relative w-full flex flex-col md:flex-row items-center justify-between gap-8 md:gap-20 py-12">
      ...
      <div className="flex-3">
        <h1 className="text-5xl md:text-7xl text-sub font-bold leading-tight md:leading-[1.5]">
        ...
        <Link
          href="/hire"
          className="flex items-center gap-2 py-3 px-6 rounded-3xl border border-white/20 text-lg md:text-xl font-medium bg-transparent text-white w-fit"
        >
          View Resume
